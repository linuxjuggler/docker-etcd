...
docker run -d -p 2379:2379 -p 2380:2380 -p 4001:4001 \
  -p 7001:7001 -v /data/backup/dir:/data --name some-etcd \
  zaherg/docker-etcd:latest
```
...
docker run -d -p 2379:2379 -p 2380:2380 -p 4001:4001 \
  -p 7001:7001 -v /data/backup/dir:/data --name some-etcd \
  zaherg/docker-etcd:latest etcd -data-dir=/data
```

```sh
docker run --rm -p 2379:2379 zaherg/docker-etcd etcd --help
